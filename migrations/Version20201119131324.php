 ...
 */
final class Version20201119131324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, description_intervention VARCHAR(255) NOT NULL, statut_intervention VARCHAR(20) NOT NULL, date_debut_intervention DATETIME NOT NULL, date_fin_intervention DATETIME NOT NULL, INDEX IDX_D11814ABFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
