 ...
 */
final class Version20210212083537 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, description_intervention VARCHAR(255) DEFAULT NULL, description_refus VARCHAR(255) DEFAULT NULL, date_fin DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, intervention_id INT DEFAULT NULL, statut_id INT DEFAULT NULL, titre_ticket VARCHAR(255) NOT NULL, description_ticket VARCHAR(255) NOT NULL, date_ticket DATETIME DEFAULT NULL, categorie_ticket VARCHAR(50) NOT NULL, nom_criticite VARCHAR(50) DEFAULT NULL, INDEX IDX_97A0ADA3FB88E14F (utilisateur_id), UNIQUE INDEX UNIQ_97A0ADA38EAE3863 (intervention_id), INDEX IDX_97A0ADA3F6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom_utilisateur VARCHAR(50) NOT NULL, prenom_utilisateur VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
