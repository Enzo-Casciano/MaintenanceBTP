 ...
 */
final class Version20201118105630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD categorie_ticket VARCHAR(50) NOT NULL, DROP salle_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE salle ADD CONSTRAINT FK_4E977E5C9F2C3FAB FOREIGN KEY (zone_id) REFERENCES zone (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_4E977E5C9F2C3FAB ON salle (zone_id)');
        $this->addSql('ALTER TABLE ticket ADD salle_id INT DEFAULT NULL, DROP categorie_ticket');
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA3DC304035 FOREIGN KEY (salle_id) REFERENCES salle (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
