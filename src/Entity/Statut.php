...
class Statut
{
    ...
    public function getCriticiteStatut(): ?string
    {
        return $this->criticiteStatut;
    }

    public function setCriticiteStatut(string $criticiteStatut): self
    {
        $this->criticiteStatut = $criticiteStatut;
